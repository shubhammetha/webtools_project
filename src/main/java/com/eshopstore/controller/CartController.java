...
import com.eshopstore.model.CartItem;
...
public class CartController {
    ...
    @ResponseStatus(value = HttpStatus.BAD_REQUEST, reason = "Wrong Request please verify ")
    public void handleClientErrors(Exception e){}

    @ExceptionHandler(Exception.class)
    @ResponseStatus(value = HttpStatus.INTERNAL_SERVER_ERROR, reason = "500 Error: Server Problem ")
